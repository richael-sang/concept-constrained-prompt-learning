...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.CCPL = CN()
    cfg.TRAINER.CCPL.N_CTX = 16
    cfg.TRAINER.CCPL.CTX_INIT = ""
    cfg.TRAINER.CCPL.CSC = False
    cfg.TRAINER.CCPL.CLASS_TOKEN_POSITION = "end"
    cfg.TRAINER.CCPL.PREC = "fp16"
    cfg.TRAINER.CCPL.CONCEPT_BANK = "concept_bank/ccpl_concepts.json"
    cfg.TRAINER.CCPL.CONCEPT_DROPOUT = 0.3
    cfg.TRAINER.CCPL.LAMBDA_TEXT = 1.0
    cfg.TRAINER.CCPL.LAMBDA_KL = 0.5
    cfg.TRAINER.CCPL.KL_T = 2.0
    cfg.TRAINER.CCPL.ENSEMBLE_ALPHA = 0.2
